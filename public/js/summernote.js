                    ...
                    (n = [
                        {
                            ...
                            value: function(t) {
                                ...
                                if (
                                    ...
                                    this.options &&
                                        this.options.data &&
                                        i.a.each(this.options.data, function(
                                            t,
                                            n
                                        ) {
                                            e.attr("data-" + t, n);
                        ...
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function(e) {
                                    ...
                                    return (
                                        e &&
                                            (n = pt.nextPointUntil(n, function(
                                                t
                                            ) {
                                                return !pt.isCharPoint(t);
                                            })),
                                    ...
                                    .on("keydown", function(e) {
                                        if (
                                            ...
                                            e.isDefaultPrevented() ||
                                                (t.options.shortcuts
                                                    ? (t.hasKeyShortCut = t.handleKeyMap(
                                                          e
                                                      ))
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                if (n && n.items && n.items.length) {
                                    ...
                                    var i = window.clipboardData.getData(
                                        "text"
                                    );
                                    this.context.invoke(
                                        "editor.isLimited",
                    ...
                    (n = [
                        {
                            ...
                            value: function() {
                                ...
                                this.options.disableResizeEditor
                                    ? this.destroy()
                                    : this.$statusbar.on("mousedown", function(
                                          e
                                      ) {
                                          e.preventDefault(),
                                              e.stopPropagation();
